    ...
    draw(context) {
      ...
      context.drawImage(
        ...
        this.x +
          ...
          this.eye1Image.width * 0.5,
        this.y +
          Math.sin(this.angle) * this.eye1Radius -
          this.eye1Image.height * 0.5
      );
      ...
      context.drawImage(
        ...
        this.x +
          ...
          this.eye2Image.width * 0.5,
        this.y +
          Math.sin(this.angle) * this.eye2Radius -
          this.eye2Image.height * 0.5
      );
      ...
      if (this.tracking) {
        context.drawImage(
          this.detectorLightImage,
          this.x - this.detectorLightImage.width * 0.5,
          this.y - this.detectorLightImage.height * 0.5 - 195
        );
      }
    }
    update() {
